...
<div
	class="mb-4 border-y px-2 pt-4 border-solid rounded-md shadow-md dark:border-orange-400 shadow-md shadow-neutral-500 sm:border-x sm:border-amber-700 sm:border-opacity-40 sm:px-4"
>
